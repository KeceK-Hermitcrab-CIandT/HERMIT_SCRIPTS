...
public class TEXDraw3DConverterTool : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        targetFontAsset = (TMP_FontAsset)EditorGUILayout.ObjectField("Font Asset (TMP)", targetFontAsset, typeof(TMP_FontAsset), false);
        ...
        {
            if (manualObjectToAdd != null && manualObjectToAdd.GetComponent("TEXDraw3D") != null && !texObjects.Contains(manualObjectToAdd))
            {
